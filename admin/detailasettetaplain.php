...
$idatl = $_GET['id'];
$get = mysqli_query($conn,"select * from asettetaplain where idatl='$idatl'");
$fetch = mysqli_fetch_assoc($get);
                    ...
                    $penciptabuku = $fetch['penciptabuku'];
                    $asalbarang = $fetch['asalbarang'];
                    $penciptabarang = $fetch['penciptabarang'];
                    $bahanbarang = $fetch['bahanbarang'];
                    $jenishewan = $fetch['jenishewan'];
                    $ukuranhewan = $fetch['ukuranhewan'];
                    $asetluas = $fetch['asetluas'];
                    $asetalamat = $fetch['asetalamat'];
                    $asettitik = $fetch['asettitik'];
                    $asetketerangan = $fetch['asetketerangan'];
                ...
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Detail</h1>
                            ...
                            <?php
                                $ambilsemuadatgedung = mysqli_query($conn,"select * from asettetaplain");
                            ...
                            <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambilsemuadatgedung = mysqli_query($conn,"select * from asettetaplain where idatl='$idatl'");
                                            $i = 1;
                                            ...
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">judul</div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$judulbuku;?></div>
                                            </div>
                                            
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">pencipta</div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$penciptabuku;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2">barang bercorak kesenian/kebudayaan/museum </div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">asal </div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$asalbarang;?></div>
                                            </div>
                                            
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">pencipta</div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$penciptabarang;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">bahan </div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$bahanbarang;?></div>
                                            </div>
                                           
                                            <div class="row">
                                            <div class="col-md-2">hewan ternak dan tumbuhan</div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">jenishewan</div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$jenishewan;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">ukuranhewan</div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$ukuranhewan;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2">aset renovasi</div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2">luas</div>
                                            <div class="col-md-9">: <?=$asetluas;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2">alamat</div>
                                            <div class="col-md-9">: <?=$asetalamat;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2">titik koordinat</div>
                                            <div class="col-md-9">: <?=$asettitik;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2">keterangan penggunaan</div>
                                            <div class="col-md-9">: <?=$asetketerangan;?></div>
                                            </div>
                                            <div class="row">
