...
$nogb = $_GET['id'];
$get = mysqli_query($conn,"select * from gedungbangunan where nogb='$nogb'");
                ...
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Detail</h1>
                            ...
                            <?php
                                $ambilsemuadatgedung = mysqli_query($conn,"select * from gedungbangunan");
                            ...
                            <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambilsemuadatgedung = mysqli_query($conn,"select * from gedungbangunan where nogb='$nogb'");
                                            $i = 1;
                                            ...
                                            <div class="row">
                                            <div class="col-md-2">titikkoor </div>
                                            <div class="col-md-9">: <?=$titikkoor;?></div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                            <div class="col-md-2">konstruksi bangunan</div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2" style="left: 1cm;">tingkat </div>
                                            <div class="col-md-9" style="left: 1cm;">: <?=$tingkat;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2"style="left: 1cm;">beton</div>
                                            <div class="col-md-9"style="left: 1cm;">: <?=$beton;?></div>
                                            </div>
