...
$idjalan = $_GET['id'];
$get = mysqli_query($conn,"select * from jalan where idjalan='$idjalan'");
                ...
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Detail</h1>
                            ...
                            <?php
                                $ambilsemuadatgedung = mysqli_query($conn,"select * from jalan");
                            ...
                            <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambilsemuadatgedung = mysqli_query($conn,"select * from jalan where idjalan='$idjalan'");
                                            $i = 1;
                                            ...
                                            <div class="col-md-9">: <?=$panjang;?></div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-2">lebar</div>
                                            <div class="col-md-9">: <?=$lebar;?></div>
                                            </div>
                                            <div class="row">
